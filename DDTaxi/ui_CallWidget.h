...
public:
    ...
    void setupUi(QWidget *CallWidget)
    {
        ...
        CallWidget->setMinimumSize(QSize(480, 325));
        CallWidget->setMaximumSize(QSize(480, 325));
        QPalette palette;
        ...
        Layout_map->setObjectName(QStringLiteral("Layout_map"));

        gridLayout->addLayout(Layout_map, 0, 1, 10, 1);
...
""));
        ...
        label_state->setPalette(palette3);
        QFont font2;
