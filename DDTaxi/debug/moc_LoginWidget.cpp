...
QT_MOC_LITERAL(4, 26, 28), // "on_pushButton_signup_clicked"
QT_MOC_LITERAL(5, 55, 28) // "on_pushButton_signin_clicked"

    },
    "LoginWidget\0login\0\0signup\0"
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (LoginWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginWidget::signup)) {
                *result = 1;
            }
        }
    }
