...
void LoginWidget::on_pushButton_signin_clicked()
{
    ...
    strcpy(info->tel, "18769360000");
    strcpy(info->nickname, "xubo");
    strcpy(info->card, "a001");
    return;*/
    ...
    connect(this, SIGNAL(login_sig(QString,QString)), worker, SLOT(signinDrv(QString,QString)));
